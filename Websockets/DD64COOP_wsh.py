...
p1path = '/home/glassknu/public_html/Dumbledore64/Websockets/data/player1.txt'
p2path = '/home/glassknu/public_html/Dumbledore64/Websockets/data/player2.txt'
obspath = '/home/glassknu/public_html/Dumbledore64/Websockets/data/obstacles.txt'
p1e = '/home/glassknu/public_html/Dumbledore64/Websockets/data/enemies1.txt'
p2e = '/home/glassknu/public_html/Dumbledore64/Websockets/data/enemies2.txt'
		...
		while True:
			try:
				...
				#update player location
					...
					if line[1] == '1':
						with open(p1e, 'r') as p1file:
							p1enemies = p1file.readlines()
						with open(p1e, 'w') as p1file:
							p1enemies[line[2]] = line[3:] + '\n'
							p1file.writelines(p1enemies)
						with open(p2e, 'r') as p2file:
							p2data = p2file.readlines()
